    ...
    <div className="min-h-screen bg-light-gray flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
        ...
        <div className="space-y-3">
          <button className="w-full flex items-center justify-center gap-3 py-3 border border-gray-300 rounded-lg hover:bg-light-gray transition-colors">
        ...
        <p className="text-center text-sm text-gray-600 mt-6">
          ...
          <Link href="/signin" className="text-royal-blue hover:underline font-semibold">
            Sign In
          </Link>
        </p>
      </div>
